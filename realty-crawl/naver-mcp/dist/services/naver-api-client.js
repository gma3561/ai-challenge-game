...
export class NaverApiClient {
    ...
    async searchWebDocuments(request) {
        try {
    ...
    async getPropertyAnalysis(propertyType, location) {
        try {
    ...
    async getInvestmentInsights(location) {
        try {
...
//# sourceMappingURL=naver-api-client.js.map