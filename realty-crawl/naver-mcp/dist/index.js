...
class NaverMCPServer {
    ...
    async handleGetPropertyDetails(args) {
    ...
    async handleGetMarketTrends(args) {
    ...
    async handleCompareProperties(args) {
    ...
    async handleSearchNaverApi(args) {
    ...
    async handleGetPropertyAnalysis(args) {
